...
def TeachersDashboard(request):
    ...
    print(user_info)
    user_more_info = TeachersList.objects.get(userId__pk=user_id)
    print(user_more_info)
    diction = {'title': 'Dashboard', 'user_info': user_info, 'user_more_info': user_more_info}
...
def TeacherProfileUpdate(request):
    ...
    return render(request, 'Teachers_app/profile_update.html', context={'form': form})
...
# Marks
class Students_listView(ListView):
