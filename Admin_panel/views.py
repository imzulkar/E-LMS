...
from .models import Course, OfferedCourse, Semester, BatchInfo
...
class AddBatchInfoView(CreateView):
    context_object_name = 'add_batch_info'
    model = BatchInfo
    fields = '__all__'
    template_name = 'Admin_panel/add_batch_info.html'
